...
test('getFileAccept', () => {
    ...
    // word
    // ----------------------------------------------------------------------
    expect(getFileAccept('word', 'doc')).toBe(accept.word.doc)
    expect(getFileAccept('word', 'docx')).toBe(accept.word.docx)
    expect(getFileAccept('word', ['doc'])).toBe(`${accept.word.doc}`)
    expect(getFileAccept('word', ['doc', 'docx'])).toBe(`${accept.word.doc},${accept.word.docx}`)
    expect(getFileAccept('word')).toBe(`${accept.word.doc},${accept.word.docx}`)
})
